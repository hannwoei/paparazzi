...
/**
 * @file modules/computer_vision/opticflow/opticflow_calculator2.h
...
#ifndef OPTICFLOW_CALCULATOR2_H
#define OPTICFLOW_CALCULATOR2_H
...
void kalman_filter2_opticflow_velocity(float *velocity_x, float *velocity_y, float *acceleration_measurement, float fps,
                                      float *measurement_noise, float process_noise, bool reinitialize_kalman);

#endif /* OPTICFLOW_CALCULATOR2_H */
