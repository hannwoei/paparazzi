...
//    fprintf(video_usb_logger, "counter,image,roll,pitch,yaw,x,y,z,sonar\n");
	  fprintf(video_usb_logger, "counter,image,FPS,vx,vy,vz,Ax,Ay,Az,sonar,flat,div,x,y,z,roll,pitch,yaw,corner,flow\n");
  }
}
...
//          ned->y, ned->z, sonar);
  fprintf(video_usb_logger, "%d,%d,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%f,%d,%d\n", counter,
          logvideo.shot_number, logvideo_data.FPS, logvideo_data.V_body_x, logvideo_data.V_body_y,
     	  logvideo_data.V_body_z, logvideo_data.A_body_x, logvideo_data.A_body_y,
     	  logvideo_data.A_body_z, logvideo_data.agl, logvideo_data.flatness,
	      logvideo_data.div, logvideo_data.gps_x, logvideo_data.gps_y,
