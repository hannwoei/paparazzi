...
/**
 * @file modules/computer_vision/opticflow/opticflow_calculator2.c
...
// Own Header
#include "opticflow_calculator2.h"
...
#ifndef OPTICFLOW2_CORNER_METHOD
#define OPTICFLOW2_CORNER_METHOD EXHAUSTIVE_FAST
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_CORNER_METHOD)

/* Set the default values */
#ifndef OPTICFLOW2_MAX_TRACK_CORNERS
#define OPTICFLOW2_MAX_TRACK_CORNERS 25
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_MAX_TRACK_CORNERS)

#ifndef OPTICFLOW2_WINDOW_SIZE
#define OPTICFLOW2_WINDOW_SIZE 10
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_WINDOW_SIZE)

#ifndef OPTICFLOW2_SEARCH_DISTANCE
#define OPTICFLOW2_SEARCH_DISTANCE 20
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_SEARCH_DISTANCE)

#ifndef OPTICFLOW2_SUBPIXEL_FACTOR
#define OPTICFLOW2_SUBPIXEL_FACTOR 10
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_SUBPIXEL_FACTOR)

#ifndef OPTICFLOW2_RESOLUTION_FACTOR
#define OPTICFLOW2_RESOLUTION_FACTOR 100
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_RESOLUTION_FACTOR)

#ifndef OPTICFLOW2_MAX_ITERATIONS
#define OPTICFLOW2_MAX_ITERATIONS 10
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_MAX_ITERATIONS)

#ifndef OPTICFLOW2_THRESHOLD_VEC
#define OPTICFLOW2_THRESHOLD_VEC 2
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_THRESHOLD_VEC)

#ifndef OPTICFLOW2_PYRAMID_LEVEL
#define OPTICFLOW2_PYRAMID_LEVEL 2
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_PYRAMID_LEVEL)

#ifndef OPTICFLOW2_FAST9_ADAPTIVE
#define OPTICFLOW2_FAST9_ADAPTIVE FALSE
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_ADAPTIVE)

// aero school
#ifndef OPTICFLOW2_FAST9_THRESHOLD
#define OPTICFLOW2_FAST9_THRESHOLD 30
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_THRESHOLD)

//#ifndef OPTICFLOW2_FAST9_THRESHOLD
//#define OPTICFLOW2_FAST9_THRESHOLD 40
//#endif
//PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_THRESHOLD)

#ifndef OPTICFLOW2_FAST9_MIN_DISTANCE
#define OPTICFLOW2_FAST9_MIN_DISTANCE 0
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_MIN_DISTANCE)

#ifndef OPTICFLOW2_FAST9_PADDING
#define OPTICFLOW2_FAST9_PADDING 20
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_PADDING)

// thresholds FAST9 that are currently not set from the GCS:
#define FAST9_LOW_THRESHOLD 5
#define FAST9_HIGH_THRESHOLD 60

#ifndef OPTICFLOW2_METHOD
#define OPTICFLOW2_METHOD 0
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_METHOD)

#if OPTICFLOW2_METHOD > 1
#error WARNING: Both Lukas Kanade and EdgeFlow are NOT selected
#endif

#ifndef OPTICFLOW2_DEROTATION
#define OPTICFLOW2_DEROTATION TRUE
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_DEROTATION)

#ifndef OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_X
#define OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_X 1.0
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_X)

#ifndef OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_Y
#define OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_Y 1.0
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_Y)

#ifndef OPTICFLOW2_MEDIAN_FILTER
#define OPTICFLOW2_MEDIAN_FILTER TRUE
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_MEDIAN_FILTER)

#ifndef OPTICFLOW2_FEATURE_MANAGEMENT
#define OPTICFLOW2_FEATURE_MANAGEMENT 0
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FEATURE_MANAGEMENT)

#ifndef OPTICFLOW2_FAST9_REGION_DETECT
#define OPTICFLOW2_FAST9_REGION_DETECT 1
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_REGION_DETECT)

#ifndef OPTICFLOW2_FAST9_NUM_REGIONS
#define OPTICFLOW2_FAST9_NUM_REGIONS 9
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_FAST9_NUM_REGIONS)

#ifndef OPTICFLOW2_ACTFAST_LONG_STEP
#define OPTICFLOW2_ACTFAST_LONG_STEP 10
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_ACTFAST_LONG_STEP)

#ifndef OPTICFLOW2_ACTFAST_SHORT_STEP
#define OPTICFLOW2_ACTFAST_SHORT_STEP 2
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_ACTFAST_SHORT_STEP)

#ifndef OPTICFLOW2_ACTFAST_GRADIENT_METHOD
#define OPTICFLOW2_ACTFAST_GRADIENT_METHOD 1
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_ACTFAST_GRADIENT_METHOD)

#ifndef OPTICFLOW2_ACTFAST_MIN_GRADIENT
#define OPTICFLOW2_ACTFAST_MIN_GRADIENT 10
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_ACTFAST_MIN_GRADIENT)

// Defaults for ARdrone
#ifndef OPTICFLOW2_BODY_TO_CAM_PHI
#define OPTICFLOW2_BODY_TO_CAM_PHI 0
#endif
#ifndef OPTICFLOW2_BODY_TO_CAM_THETA
#define OPTICFLOW2_BODY_TO_CAM_THETA 0
#endif
#ifndef OPTICFLOW2_BODY_TO_CAM_PSI
#define OPTICFLOW2_BODY_TO_CAM_PSI -M_PI_2
#endif

// Tracking back flow to make the accepted flow vectors more robust:
// Default is false, as it does take extra processing time
#ifndef OPTICFLOW2_TRACK_BACK
#define OPTICFLOW2_TRACK_BACK FALSE
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_TRACK_BACK)

// Whether to draw the flow on the image:
// False by default, since it changes the image and costs time.
#ifndef OPTICFLOW2_SHOW_FLOW
#define OPTICFLOW2_SHOW_FLOW FALSE
#endif
PRINT_CONFIG_VAR(OPTICFLOW2_SHOW_FLOW)
...
static void manage_flow_features(struct image_t *img, struct opticflow2_t *opticflow,
                                 struct opticflow_result_t *result);

static struct flow_t *predict_flow_vectors(struct flow_t *flow_vectors, uint16_t n_points, float phi_diff,
    float theta_diff, float psi_diff, struct opticflow2_t *opticflow);
/**
 * Initialize the opticflow calculator
 * @param[out] *opticflow The new optical flow calculator
 */
void opticflow2_calc_init(struct opticflow2_t *opticflow)
{
  /* Set the default values */
  opticflow->method = OPTICFLOW2_METHOD; //0 = LK_fast9, 1 = Edgeflow
  opticflow->window_size = OPTICFLOW2_WINDOW_SIZE;
  opticflow->search_distance = OPTICFLOW2_SEARCH_DISTANCE;
  opticflow->derotation = OPTICFLOW2_DEROTATION; //0 = OFF, 1 = ON
  opticflow->derotation_correction_factor_x = OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_X;
  opticflow->derotation_correction_factor_y = OPTICFLOW2_DEROTATION_CORRECTION_FACTOR_Y;
  opticflow->track_back = OPTICFLOW2_TRACK_BACK;
  opticflow->show_flow = OPTICFLOW2_SHOW_FLOW;
  opticflow->max_track_corners = OPTICFLOW2_MAX_TRACK_CORNERS;
  opticflow->subpixel_factor = OPTICFLOW2_SUBPIXEL_FACTOR;
  if (opticflow->subpixel_factor == 0) {
    opticflow->subpixel_factor = 10;
  }
  opticflow->resolution_factor = OPTICFLOW2_RESOLUTION_FACTOR;
  opticflow->max_iterations = OPTICFLOW2_MAX_ITERATIONS;
  opticflow->threshold_vec = OPTICFLOW2_THRESHOLD_VEC;
  opticflow->pyramid_level = OPTICFLOW2_PYRAMID_LEVEL;
  opticflow->median_filter = OPTICFLOW2_MEDIAN_FILTER;
  opticflow->feature_management = OPTICFLOW2_FEATURE_MANAGEMENT;
  opticflow->fast9_region_detect = OPTICFLOW2_FAST9_REGION_DETECT;
  opticflow->fast9_num_regions = OPTICFLOW2_FAST9_NUM_REGIONS;

  opticflow->fast9_adaptive = OPTICFLOW2_FAST9_ADAPTIVE;
  opticflow->fast9_threshold = OPTICFLOW2_FAST9_THRESHOLD;
  opticflow->fast9_min_distance = OPTICFLOW2_FAST9_MIN_DISTANCE;
  opticflow->fast9_padding = OPTICFLOW2_FAST9_PADDING;
  opticflow->fast9_rsize = 512;
  opticflow->fast9_ret_corners = calloc(opticflow->fast9_rsize, sizeof(struct point_t));

  opticflow->corner_method = OPTICFLOW2_CORNER_METHOD;
  opticflow->actfast_long_step = OPTICFLOW2_ACTFAST_LONG_STEP;
  opticflow->actfast_short_step = OPTICFLOW2_ACTFAST_SHORT_STEP;
  opticflow->actfast_min_gradient = OPTICFLOW2_ACTFAST_MIN_GRADIENT;
  opticflow->actfast_gradient_method = OPTICFLOW2_ACTFAST_GRADIENT_METHOD;

  struct FloatEulers euler = {OPTICFLOW2_BODY_TO_CAM_PHI, OPTICFLOW2_BODY_TO_CAM_THETA, OPTICFLOW2_BODY_TO_CAM_PSI};
 ...
 */
bool calc2_fast9_lukas_kanade(struct opticflow2_t *opticflow, struct image_t *img,
                             struct opticflow_result_t *result)
{
  ...
  if ((opticflow->feature_management) && (result->corner_cnt < opticflow->max_track_corners / 2)) {
    ...
    if (opticflow->corner_method == EXHAUSTIVE_FAST) {
      ...
      act_fast(&opticflow->prev_img_gray, opticflow->fast9_threshold, &result->corner_cnt,
               &opticflow->fast9_ret_corners, n_agents2, n_time_steps2,
    ...
    if (opticflow->fast9_adaptive) {
      ...
      if (result->corner_cnt < 40) { // TODO: Replace 40 with OPTICFLOW2_MAX_TRACK_CORNERS / 2
      ...
      } else if (result->corner_cnt > OPTICFLOW2_MAX_TRACK_CORNERS * 2 && opticflow->fast9_threshold < FAST9_HIGH_THRESHOLD) {
        opticflow->fast9_threshold++;
        if (opticflow->corner_method == ACT_FAST && n_time_steps2 > 5 && n_agents2 > 10) {
          n_time_steps2--;
          n_agents2--;
        }
      }
  ...
  if (opticflow->derotation && result->tracked_cnt > 5) {
    ...
    if (fabs(opticflow->img_gray.eulers.phi - opticflow->prev_img_gray.eulers.phi) > rotation_threshold
      ...
      if (strcmp(OPTICFLOW2_CAMERA.dev_name, "/dev/video0") == 0) {

        // bottom cam: just subtract a scaled version of the roll and pitch difference from the global flow vector:
        diff_flow_x = phi_diff * OPTICFLOW2_CAMERA.camera_intrinsics.focal_x; // phi_diff works better than (cam_state->rates.p)
        diff_flow_y = theta_diff * OPTICFLOW2_CAMERA.camera_intrinsics.focal_y;
  ...
  result->vel_cam.x = (float)result->flow_der_x * result->fps * agl_dist_value_filtered /
                      (opticflow->subpixel_factor * OPTICFLOW2_CAMERA.camera_intrinsics.focal_x);
  result->vel_cam.y = (float)result->flow_der_y * result->fps * agl_dist_value_filtered /
                      (opticflow->subpixel_factor * OPTICFLOW2_CAMERA.camera_intrinsics.focal_y);
    ...
    float theta_diff, float psi_diff, struct opticflow2_t *opticflow)
{
  ...
  float K[9] = {OPTICFLOW2_CAMERA.camera_intrinsics.focal_x, 0.0f, OPTICFLOW2_CAMERA.camera_intrinsics.center_x,
                0.0f, OPTICFLOW2_CAMERA.camera_intrinsics.focal_y, OPTICFLOW2_CAMERA.camera_intrinsics.center_y,
                0.0f, 0.0f, 1.0f
               };
  // TODO: make an option to not do distortion / undistortion (Dhane_k = 1)
  float k = OPTICFLOW2_CAMERA.camera_intrinsics.Dhane_k;

  float A, B, C; // as in Longuet-Higgins

  if (strcmp(OPTICFLOW2_CAMERA.dev_name, "/dev/video1") == 0) {
 ...
 *
 */
static void manage_flow_features(struct image_t *img, struct opticflow2_t *opticflow, struct opticflow_result_t *result)
{
 ...
 */
bool calc2_edgeflow_tot(struct opticflow2_t *opticflow, struct image_t *img,
                       struct opticflow_result_t *result)
{
  ...
  if (opticflow->derotation) {
    der_shift_x = (int16_t)((edge_hist[current_frame_nr].eulers.phi - edge_hist[previous_frame_nr[0]].eulers.phi) *
                            OPTICFLOW2_CAMERA.camera_intrinsics.focal_x * opticflow->derotation_correction_factor_x);
    der_shift_y = (int16_t)((edge_hist[current_frame_nr].eulers.theta - edge_hist[previous_frame_nr[1]].eulers.theta) *
                            OPTICFLOW2_CAMERA.camera_intrinsics.focal_y * opticflow->derotation_correction_factor_y);
  }
  ...
  */
  ...
  // Calculate velocity
  result->vel_cam.x = edgeflow.flow_x * fps_x * agl_dist_value_filtered * OPTICFLOW2_CAMERA.camera_intrinsics.focal_x /
                      RES;
  result->vel_cam.y = edgeflow.flow_y * fps_y * agl_dist_value_filtered * OPTICFLOW2_CAMERA.camera_intrinsics.focal_y /
                      RES;
 ...
 * @param[out] *result The optical flow result
 */
bool opticflow2_calc_frame(struct opticflow2_t *opticflow, struct image_t *img,
                          struct opticflow_result_t *result)
{
  ...
  if (opticflow->method == 0) {
    flow_successful = calc2_fast9_lukas_kanade(opticflow, img, result);
  } else if (opticflow->method == 1) {
    flow_successful = calc2_edgeflow_tot(opticflow, img, result);
  }
